//
//  SwipeSheetViewController+Theme.m
//

#import "SwipeSheetViewController+Theme.h"
#import <objc/runtime.h>

@interface SwipeSheetViewController ()
...
@implementation SwipeSheetViewController (Theme)
...
- (void)setUpLightTheme {
    ...
    self.handleButtonIcon = [UIImage imageNamed:@"SwipeSheetHandleButtonIcon.png"];
}
